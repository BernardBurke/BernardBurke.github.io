...
echo "categories: [ podcasts,  ]" >> $POSTS_FILENAME
echo "tags: [ podcasts,  ]" >> $POSTS_FILENAME
...
echo "image: "https://link-to-pod-image"" >> $POSTS_FILENAME
...
# below is an imperfect solution for disabling comments in posts until I figure out how I want to implement them
echo "comments: false " >> $POSTS_FILENAME
echo "---" >> $POSTS_FILENAME
